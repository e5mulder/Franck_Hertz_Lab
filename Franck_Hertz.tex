...
\begin{table}[h!]
\centering
\caption{Values for minima spacing with uncertainty, determined by three methods: estimating by eye from the plot of lock-in data, estimating by eye from the plot of data taken without the lock-in, and calculating from the curve fits to the lock-in minima as described in the analysis section. Our eyeball estimates had the lowest uncertainty. Plotted in Figure ~\ref{nomineye}}
\begin{ruledtabular}
