...
At this point, we decided to use the old-fashioned method of estimating our minimum by eye as well as the uncertainty. Then we calculated the difference in the accelerating voltage of successive minima (Table ~\ref{minimaSpacing} and Fig. \ref{nomineye}). 
...
\bibitem{newFeatures}Rapior, Gerald; Sengstock, Klaus; Baev, Valery. "New features of the Franck-Hertz experiment." Am. J. Phys. 74, 423 (2006); doi: 10.1119/1.2174033. 
\end{thebibliography}
\end{document}
